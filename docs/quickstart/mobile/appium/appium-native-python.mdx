---
title: Appium Native for Python and Applitools Tutorial
sidebar_label: Appium for Python
---
import PartialOutro from '@site/docs/_partials/_partials-outro_.mdx'


# Appium Native Python Tutorial
...
class HelloWorld:
    ...
    desired_caps['app'] = 'https://applitools.jfrog.io/artifactory/Examples/eyes-ios-hello-world.zip'
