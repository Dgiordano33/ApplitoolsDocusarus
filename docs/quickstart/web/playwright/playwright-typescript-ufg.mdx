---
title: Playwright Typescript UFG and Applitools Tutorial
sidebar_label: Playwright Typscript UFG
---
...
This tutorial will show you how to automate visual tests using the Applitools Ultrafast Grid with Playwright in TypeScript.
...
clone the [example repository](https://github.com/applitools/example-playwright-typescript-ufg)
and follow the [README](https://github.com/applitools/example-playwright-typescript-ufg/blob/master/README.md) instructions!
:::
...
[https://github.com/applitools/example-playwright-typescript-ufg](https://github.com/applitools/example-playwright-typescript-ufg).
...
you can [download the project as a ZIP file](https://github.com/applitools/example-playwright-typescript-ufg/archive/refs/heads/master.zip)
and extract it.*
...
Since this project uses the Ultrafast Grid, it is recommended to use only one browser for local execution.
