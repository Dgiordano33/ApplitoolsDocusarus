...
import PartialIntro from './_tutorial-intro.mdx';
import PartialOutro from './_next-steps.mdx';


# Cypress Tutorials

<PartialIntro name="Cypress" repo="https://github.com/applitools/example-cypress-javascript-ufg"/>
